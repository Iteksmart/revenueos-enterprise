...
const providerCatalog = [
  ...
  { provider: "apollo", category: "prospecting", authType: "api_key", scopes: ["contacts.read", "people.search"] },
  { provider: "gohighlevel", category: "crm", authType: "api_key", scopes: ["contacts.read", "opportunities.read"] },
  { provider: "notion", category: "knowledge", authType: "api_key", scopes: ["pages.read", "databases.read"] },
